    ...
    return (
        <main className="flex min-h-screen flex-col bg-brand-bg text-brand-text font-sans selection:bg-brand-primary selection:text-white">
            ...
            <section className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #020617 0%, #0a1a3a 20%, #0f3577 45%, #1e3a8a 60%, #1a3070 75%, #0a1628 100%)' }}>
                ...
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_50%_70%_at_65%_60%,rgba(37,99,235,0.35)_0%,rgba(30,58,138,0.15)_40%,transparent_70%)]" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_40%_50%_at_60%_55%,rgba(59,130,246,0.2)_0%,transparent_60%)]" />

                <div className="container-custom relative z-10 pt-32 pb-16 lg:pt-20 lg:pb-0">
                    <div className="lg:grid lg:grid-cols-[5fr_7fr] lg:gap-12 lg:items-end">
                        {/* Texto à esquerda */}
                        <div className="space-y-6 animate-fade-in-up lg:pt-16 xl:pt-24 lg:pb-16">
                            ...
                            <h1 className="text-5xl font-bold uppercase leading-[0.9] tracking-tighter sm:text-4xl lg:text-5xl xl:text-7xl text-white">
                                MAIS FORTE <br />
                                A CADA DIA <br />
                                COMIGO
                            </h1>

                            <p className="max-w-lg text-base text-white/60 sm:text-lg font-light tracking-wide leading-relaxed">
                            ...
                            <div className="flex flex-wrap gap-4 pt-2">
                                <Link
                                    ...
                                    className="group inline-flex items-center justify-center rounded-full bg-brand-accent px-8 py-4 text-base font-bold text-black transition-all hover:bg-yellow-300 hover:scale-105 hover:shadow-lg"
                                >
                        ...
                        <div className="relative mt-12 lg:mt-0 flex justify-center">
                            ...
                            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 flex items-center justify-center rounded-full bg-white/10 backdrop-blur-md border border-white/20 px-6 py-3 shadow-lg">
                                <span className="text-xs font-bold uppercase tracking-wider text-white">1000+ Sessões Concluídas</span>
                            </div>
                            ...
                            <Image
                                ...
                                width={600}
                                height={750}
                                className="object-contain drop-shadow-[0_0_50px_rgba(0,0,0,0.3)] w-full"
                                priority
                            />
                        </div>
                    </div>
            ...
            {/* ABOUT SECTION */}
            <section id="sobre" className="bg-black py-24 relative overflow-hidden">
                <div className="container-custom relative z-10">
                    {/* Top row: image + intro text */}
                    <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
                        <div className="relative flex justify-center lg:justify-start">
                            <div className="relative aspect-[3/4] w-full max-w-md overflow-hidden grayscale hover:grayscale-0 transition-all duration-700 group">
                        ...
                        <div>
                            <h2 className="mb-8 text-5xl font-bold uppercase leading-[0.9] tracking-tighter text-white sm:text-6xl lg:text-7xl">
                                Mais de 20 anos <br />
                            ...
                            <div className="mt-12 grid grid-cols-3 gap-6 border-t border-white/10 pt-8">
                                <div>
                                    <h3 className="text-3xl font-bold text-brand-primary mb-2">20+</h3>
                                    <p className="text-xs uppercase tracking-widest text-gray-500">Anos de<br />Experiência</p>
                                </div>
                                <div>
                                    <h3 className="text-3xl font-bold text-brand-primary mb-2">500+</h3>
                                    <p className="text-xs uppercase tracking-widest text-gray-500">Alunos<br />Satisfeitos</p>
                                </div>
                                <div>
                                    <h3 className="text-3xl font-bold text-brand-primary mb-2">1000+</h3>
                                    <p className="text-xs uppercase tracking-widest text-gray-500">Sessões<br />Concluídas</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-20">
                        <p className="text-xs font-bold uppercase tracking-[0.2em] text-gray-500 mb-6">Onde atuo</p>
            ...
            <section id="tecnologia" className="bg-neutral-950 py-32 relative overflow-hidden">
                {/* Background glow */}
                <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-brand-primary/5 blur-[150px] rounded-full -translate-y-1/2 translate-x-1/2" />
            ...
            {/* PLANS SECTION */}
            <section id="planos" className="bg-neutral-950 py-32 relative">
                <div className="container-custom relative z-10">
                    <div className="mb-20 text-center">
                        <h2 className="text-5xl font-bold uppercase tracking-tighter sm:text-6xl lg:text-7xl">
            ...
            <section id="testimonials" className="bg-brand-primary py-32 text-white relative">
            ...
            {/* FAQ SECTION */}
            <section id="faq" className="bg-brand-bg py-32">
                <div className="container-custom">
                    <h2 className="text-6xl font-bold uppercase tracking-tighter text-white mb-20 text-center lg:text-left">FAQ</h2>
                        ...
                        <div className="divide-y divide-white/10 border-t border-white/10">
                            ...
                            <div className="group py-6">
                                <h3 className="flex items-center justify-between text-xl font-bold uppercase text-white cursor-pointer group-hover:text-brand-primary transition-colors">
                                    <span>1. POSSO CANCELAR A QUALQUER MOMENTO?</span>
                            ...
                            <div className="group py-6">
                                <h3 className="flex items-center justify-between text-xl font-bold uppercase text-white cursor-pointer group-hover:text-brand-primary transition-colors">
                                    <span>2. QUANTO TEMPO DURAM AS SESSÕES?</span>
                                    <ChevronDown className="h-5 w-5 text-gray-500 transition-transform group-hover:rotate-180" />
                                </h3>
                            </div>
                            ...
                            <div className="group py-6">
                                <h3 className="flex items-center justify-between text-xl font-bold uppercase text-white cursor-pointer group-hover:text-brand-primary transition-colors">
                                    <span>3. PRECISO DE EQUIPAMENTOS?</span>
                                    <ChevronDown className="h-5 w-5 text-gray-500 transition-transform group-hover:rotate-180" />
                                </h3>
                            </div>
                            ...
                            <div className="group py-6">
                                <h3 className="flex items-center justify-between text-xl font-bold uppercase text-white cursor-pointer group-hover:text-brand-primary transition-colors">
                                    <span>4. COMO ACOMPANHO MEU PROGRESSO?</span>
                                    <ChevronDown className="h-5 w-5 text-gray-500 transition-transform group-hover:rotate-180" />
                                </h3>
                            </div>
                            <div className="group py-6">
                                <h3 className="flex items-center justify-between text-xl font-bold uppercase text-white cursor-pointer group-hover:text-brand-primary transition-colors">
                                    <span>5. A CONSULTORIA É APENAS ONLINE?</span>
                                    <ChevronDown className="h-5 w-5 text-gray-500 transition-transform group-hover:rotate-180" />
                                </h3>
                            </div>
                        </div>
            ...
            <section className="bg-neutral-900 py-24 text-center">
                <div className="container-custom">
                    <h2 className="mb-4 text-4xl sm:text-6xl font-bold uppercase leading-tight">
            ...
            <footer className="bg-black py-20 border-t border-white/10">
                <div className="container-custom flex flex-col items-center justify-between gap-12 md:flex-row">
                    <div>
                        <h2 className="text-4xl font-bold uppercase tracking-tighter text-white">Flávio Di Giovanni</h2>
